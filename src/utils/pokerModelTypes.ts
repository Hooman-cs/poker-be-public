 ...
 * Only interfaces used by more than one file live here.
 * All model-specific interfaces live in their respective model files.
 * All engine-specific interfaces live in their respective engine files.
 */
